...
This companion reference contains the detailed audit checklist and platform-specific considerations for the SEO + AI SEO skill. Load it for full audits, implementation planning, or when a specialist check requires more detail.
